...
//		User user = new User(authorities, "hiba@gmail.com", true, "hiba", new Date(), hashedPassword, "hiba", "malhis");
		User user = new User(authorities, "hiba@gmail.com", true, "hiba", new Date(), "1234", "hiba", "malhis");
	...
	private void createPresses() {
		...
		Press press = new Press("Shani - MR306", "/api/image/S4SF.png", "Shani", "", "S4SF", "", "", "", "", "", "", "",
				"", "", hub, media, components);
		pressRepository.save(press);

		press = new Press("Eilat - PP14", "/api/image/S4SF.png", "Eilat", "50000114", "S4SF", "", "", "", "", "", "", "",
				"", "", hub, media, components);
		pressRepository.save(press);

		press = new Press("Meron - 35",  "/api/image/S4SF.png", "Meron", "40000035", "S3SF", "", "", "", "", "", "", "", "",
				"", hub, media, components);
		pressRepository.save(press);

		press = new Press("Yagur - 230",  "/api/image/S4SF.png", "Yagur", "43000230", "S4SF", "", "", "", "", "", "", "",
				"", "", hub, media, components);
		pressRepository.save(press);
		...
		press = new Press("Geva - 177", "/api/image/S4SF.png", "Geva", "44000177", "S3Web", "", "", "", "", "", "", "",
				"", "", hub, media, components);
		pressRepository.save(press);

		press = new Press("Arbel - 01",  "/api/image/S4SF.png", "Arbel", "47000001", "S3SF", "", "", "", "", "", "", "", "",
				"", hub, media, components);
		pressRepository.save(press);

		press = new Press("Kinneret - 01",  "/api/image/S4SF.png", "Kinneret", "", "S2SF", "", "", "", "", "", "", "", "",
				"", hub, media, components);
		pressRepository.save(press);
	...
	@Autowired
	private MediaTypeRepository mediaTypesRepository;

	private void createMedia() {

		RequestMedia media = new RequestMedia("Condat 115gsm Gloss primed 33");
		mediaRepository.save(media);
		MediaTypes m1 = new MediaTypes("Roll1", media);
		MediaTypes m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Hadar top 110gsm primed 33");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll2", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("PET clear (Sarafil -DP100-1G) 12mic primed 33");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll3", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Condat Digital 135gsm Gloss 32x46.4 LG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll4", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Condat Digital 170gsm matte 32x46.4 LG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll5", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Condat Digital 170gsm Gloss 32x46.4 LG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll6", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Munken 170gsm 32x46.4");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll7", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Hadar top 170gsm Uncoated 75x53 SG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll8", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Century Soho symbol free life (PW) 130gsm Gloss 75x53 SG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll9", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Century Soho symbol free life 170gsm Gloss 75x53 SG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll0", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Anthem 148gsm 75x53 coated matte");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		mediaTypesRepository.save(m2);

		media = new RequestMedia("Invercote G SBB/GZ 300gsm  53x75 LG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
		...
		media = new RequestMedia("Printa_WLC/GD2 300gsm  50x70 LG");
		mediaRepository.save(media);
		m1 = new MediaTypes("Roll", media);
		m2 = new MediaTypes("Sheets (# package)", media);
		mediaTypesRepository.save(m1);
	...
	private void createProjects() {
		...
		product.add(productRepository.findByName("BKT"));
		product.add(productRepository.findByName("BID"));
		product.add(productRepository.findByName("Blanket"));
		...
		projectRepository.save(new Project("Duplex cleaner page color change", 1, "Ink consumption reduction", 0, true,
				"CPP", hub, product));

		projectRepository.save(new Project("Ijote", 1, "PSM", 0, true, "CPP", hub, product));

		projectRepository.save(new Project("Speedup Gemini 3", 1, "Capacity", 0, true, "Capacity", hub, product));

		projectRepository.save(new Project("Speedup Timna 2", 1, "Capacity", 0, true, "Capacity", hub, product));
		...
		projectRepository.save(
				new Project("ER Ser. 4", 1, "D2D,esclations ,QOC,MRB SAP, S&M etc.", 0, true, "ER", hub, product));

		projectRepository.save(
				new Project("ER Ser. 3&2", 1, "D2D,esclations ,QOC,MRB SAP, S&M etc.", 0, true, "ER", hub, product));

		projectRepository.save(new Project("NE upgrade phase 2", 2, "", 0, true, "Capacity", hub, product));

		projectRepository.save(
				new Project("Ser4 additional CPP reduction", 1, "needs brainstorming", 0, true, "CPP", hub, product));

		projectRepository.save(new Project("Lab automation", 1, "", 0, true, "Capacity", hub, product));
		projectRepository.save(new Project("CSL cure time optimization", 1, "", 0, true, "Capacity", hub, product));
		...
		projectRepository.save(
				new Project("blanket critical parameters investigation", 2, "", 0, true, "Quality", hub, product));
		...
		projectRepository.save(new Project("Timna 2i –  Keshet release", 1,
				"Negative Dot Gain reduction, PSTB, Release loss", 0, true, "NPI", hub, product));
		projectRepository.save(new Project("Paper lateral movement - SF", 2, "Paper cut marks prevention", 0, true,
				"CPP", hub, product));
		...
		projectRepository.save(
				new Project("Electrical Memory Erase", 2, "Negativ memory reduction ", 0, true, "CPP", hub, product));
		...
		projectRepository.save(new Project("Print cleaner UI change ", 2, "Quick and handy Pribt cleaner usege ", 0,
				true, "CPP", hub, product));
		projectRepository.save(
				new Project("ISWAN", 2, "Blanket dirtiness on anti seam, PIP scratches", 0, true, "CPP", hub, product));
		projectRepository.save(new Project("2 Dimensions movement - Web", 2, "Negative Dot Gain reduction", 0, true,
				"CPP", hub, product));
		projectRepository.save(
				new Project("T2 width correction", 2, "Paper cut marks prevention", 0, true, "CPP", hub, product));
		projectRepository.save(new Project("Print cleaner UI change", 2, "Quick and handy Print cleaner usege ", 0,
				true, "CPP", hub, product));
		projectRepository.save(new Project("Polaris ", 2, "", 0, true, "NPI", hub, product));
		projectRepository.save(new Project("Ser. 3 CSL 120 ", 2, "cost reduction 1.7 million $ per year", 0, true,
				"CPP", hub, product));
		...
		projectRepository.save(new Project("Inkformation: Cyan OD drop,background 25% improve all series ", 2, "", 0,
				true, "Quality", hub, product));
		projectRepository.save(new Project("ER tasks( SG, QOC/MRB, SAP/Marketing,escalation  etc)", 1, "", 0, true,
				"ER", hub, product));
		...
		product.add(productRepository.findByName("PIP"));
		product.add(productRepository.findByName("INK"));
		product.add(productRepository.findByName("Blanket"));
		product.add(productRepository.findByName("OMP"));

		projectRepository.save(
				new Project("Spongilla - Ser3 SF", 1, "CPP - reduce PIP scratches", 0, true, "NPI", hub, product));
		projectRepository.save(
				new Project("Spongilla - Ser3  Web", 1, "CPP - reduce PIP scratches", 0, true, "NPI", hub, product));
		projectRepository.save(new Project("Overall PIP Automation- \r\n" + "Phase I + Phase II", 1,
				...
				hub, product));
		projectRepository
				.save(new Project("Cutter #6 (ser4)", 1, "Ser4 Capacity at MCC", 0, true, "AOS", hub, product));
		...
		projectRepository.save(
				new Project("Ser4 transfer (QOC/MRB/production issues)", 1, "Support", 0, true, "ER", hub, product));
		...
		projectRepository.save(new Project("Full TK - MCC", 2,
				...
				product));
		projectRepository.save(
				new Project("Onyx DR", 2, "CPP - Carbon black DR to reduce PIP OPS", 0, true, "CPP", hub, product));
